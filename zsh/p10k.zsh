# Generated by Powerlevel10k configuration wizard on 2024-12-13 at 20:58 EST.
...
# slanted separators, blurred heads, blurred tails, 2 lines, disconnected, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_ENABLED=false
  ...
  typeset -g POWERLEVEL9K_VCS_{STAGED,UNSTAGED,UNTRACKED,CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND}_MAX_NUM=100000
