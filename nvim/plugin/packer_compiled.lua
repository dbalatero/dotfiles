...
_G.packer_plugins = {
  ...
  ["vim-which-key"] = {
    ...
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-which-key",
...
try_loadstring("\27LJ\2\n0\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\21config.which-key\frequire\0", "config", "vim-which-key")
