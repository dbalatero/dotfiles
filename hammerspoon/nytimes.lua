...
local function refreshNytimesSubscription()
  ...
  afterClipboardUpdate(lastCount, function()
    ...
    hs.timer.doAfter(1, function()
      hs.eventtap.keyStroke({'cmd'}, 'l', 0)
      hs.eventtap.keyStrokes("https://nytimes.com/subscription/promotions/lp3FURL.html?campaignId=7LYRX&gift_code=0fb2197f29d62eee")
      ...
      hs.timer.doAfter(1, function()
        ...
        hs.timer.doAfter(1, function()
          ...
          hs.eventtap.keyStrokes("document.querySelector('.giftRedeem__submitButton').click();")
          hs.eventtap.keyStroke({}, 'return', 0)

          hs.timer.doAfter(1, function()
            hs.eventtap.keyStrokes("document.querySelector('[data-testid=google-sso-button]').click();")
            hs.eventtap.keyStroke({}, 'return', 0)

            hs.timer.doAfter(3, function()
              hs.eventtap.keyStroke({}, 'f12', 0)
              hs.timer.doAfter(2, function()
                hs.eventtap.keyStrokes("document.querySelector('[role=link][data-identifier=\"" .. googleEmail .. "\"').click();")
                hs.eventtap.keyStroke({}, 'return', 0)
