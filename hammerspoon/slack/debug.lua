...
module.printElement = function(element)
  ...
  p(
    "  AXDescription:     " .. tostring(element:attributeValue("AXDescription"))
  )
  p(
    "  AXRoleDescription: "
      .. tostring(element:attributeValue("AXRoleDescription"))
  )
  p("  AXAccessKey:       " .. tostring(element:attributeValue("AXAccessKey")))
  p(
    "  AXDOMIdentifier:   "
      .. tostring(element:attributeValue("AXDOMIdentifier"))
  )
  p(
    "  AXDOMClassList:    "
      .. hs.inspect.inspect(element:attributeValue("AXDOMClassList"))
  )
